...
void BasicText::DrawHUD()
{
    ...
    textRenderer->RenderText("space : toggle solid/wireframe/points", 5.0f,
                             kTopY + kRowHeight * rowIndex++, 1.0f, kTextColor);
    textRenderer->RenderText("    z : draw in wireframe mode", 5.0f,
                             kTopY + kRowHeight * rowIndex++, 1.0f, kTextColor);
    textRenderer->RenderText("    x : draw in points mode", 5.0f, kTopY + kRowHeight * rowIndex++,
                             1.0f, kTextColor);
    textRenderer->RenderText("    c : draw in solid mode", 5.0f, kTopY + kRowHeight * rowIndex++,
                             1.0f, kTextColor);

    textRenderer->RenderText("Current mode: " + polygonModeText, 5.0f,
                             kTopY + kRowHeight * rowIndex++, 1.0f, kTextColor);
}
