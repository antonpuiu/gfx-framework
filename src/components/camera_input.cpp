...
gfxc::ImplementedCameraInput::ImplementedCameraInput(implemented::Camera* camera)
{
    this->camera = camera;
}

void gfxc::ImplementedCameraInput::OnInputUpdate(float deltaTime, int mods)
{
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
        return;
...
void gfxc::ImplementedCameraInput::OnKeyPress(int key, int mods)
{
}
...
void gfxc::ImplementedCameraInput::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
    if (IS_BIT_SET(button, GLFW_MOUSE_BUTTON_RIGHT)) {
        window->DisablePointer();
    }
...
void gfxc::ImplementedCameraInput::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
    if (IS_BIT_SET(button, GLFW_MOUSE_BUTTON_RIGHT)) {
        window->ShowPointer();
    }
